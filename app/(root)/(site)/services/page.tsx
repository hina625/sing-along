            ...
            <section className="slice slice-lg !bg-bg-dark relative py-12">
                <div className="container relative z-10 mx-auto px-4 md:px-6">
                    <div className="flex flex-col md:flex-row items-center gap-16">
                        ...
                        >
                            <h2 className="text-2xl md:text-5xl lg:text-6xl text-gradient mb-6 leading-tight">Easy to set up, <br />Instant to Join</h2>
                            ...
                            <div className="p-3 md:p-5 rounded-2xl bg-white/[0.03] border border-white/5 backdrop-blur-sm w-full">
                ...
                <div className="container relative z-10 mx-auto px-4 md:px-6">
                    <div className="flex flex-col md:flex-row-reverse items-center gap-16">
                        <motion.div 
                            ...
                            className="w-full md:w-1/2"
                        >
                            <h2 className="text-xl md:text-5xl lg:text-6xl text-gradient mb-6 leading-tight">Total Privacy, Full Control</h2>
                            ...
                            <div className="grid grid-cols-2 gap-3 md:gap-4">
                                <div className="p-3 md:p-4 rounded-xl bg-white/5 border border-white/5 text-center">
                                    <div className="text-praise-orange mb-2 text-xl md:text-2xl flex justify-center"><IoMdLock /></div>
                                    <h4 className="text-white font-bold text-xs md:text-base">P2P Encrypted</h4>
                                </div>
                                <div className="p-3 md:p-4 rounded-xl bg-white/5 border border-white/5 text-center">
                                    <div className="text-deep-gold mb-2 text-xl md:text-2xl flex justify-center"><IoMdPulse /></div>
                                    <h4 className="text-white font-bold text-xs md:text-base">Pro Sync</h4>
                                </div>
                            </div>
                        </motion.div>
                        <motion.div 
                ...
                <div className="container relative z-10 mx-auto px-4 md:px-6">
                    <div className="flex flex-col md:flex-row items-center gap-16">
                        <motion.div 
                            ...
                            className="w-full md:w-1/2"
                        >
                            <h2 className="text-2xl md:text-5xl lg:text-6xl text-gradient mb-6 leading-tight">Unlimited Meetings <br />& Recordings</h2>
                            <p className="text-base md:text-lg !text-white/80 mb-6 leading-relaxed">
            ...
            <section className="slice slice-lg !bg-bg-dark py-24 relative">
                <div className="container relative z-10 mx-auto px-4 md:px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-2xl md:text-5xl text-gradient mb-4">Unified Feature Suite</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {keyFeatures.map((feature, i) => (
                            <motion.div 
                                ...
                                viewport={{ once: true }}
                                className="flex flex-col items-center text-center gap-3 p-4 rounded-xl bg-white/5 border border-white/5 group hover:bg-white/10 transition-all cursor-default"
                            >
                                <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-deep-gold/10 text-deep-gold flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <IoMdCheckmark size={18} />
                                </div>
                                <div className="flex flex-col">
                                    <h4 className="text-white font-bold text-base md:text-lg">{feature.title}</h4>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
                        {supportOptions.map((opt, i) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                whileHover={{ y: -8 }}
                                className="card-awesome-black p-5 md:p-6 rounded-2xl text-center flex flex-col items-center max-w-sm mx-auto w-full"
                            >
                                <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-royal-purple to-burgundy text-white flex items-center justify-center text-xl md:text-2xl mb-3 md:mb-4 shadow-lg shadow-royal-purple/20">
                                    {opt.icon}
                                </div>
                                <h3 className="text-lg md:text-xl font-bold text-white mb-2">{opt.title}</h3>
                                <p className="text-white/70 text-sm mb-4 md:mb-6 leading-relaxed px-2 md:px-4">{opt.desc}</p>
                                <a href={opt.link} className="mt-auto px-4 py-1.5 rounded-lg bg-white/5 border border-white/10 text-white text-xs font-bold hover:bg-white hover:text-black transition-all">
                                    Contact Now
                                </a>
                            </motion.div>
                        ))}
